...
COMMENT ON COLUMN TB_SHARE_FILE.FILENAME IS '파일이름';
COMMENT ON COLUMN TB_SHARE_FILE.FILEPATH IS '파일경로';
COMMENT ON COLUMN TB_SHARE_FILE.FILESIZE IS '파일사이즈';
...
INSERT INTO TB_G_QNA VALUES(1,'첫번째모임','언제에요?',SYSDATE,2,1);
INSERT INTO TB_G_QNA VALUES(2,'모임장소대여','어디가좋을까요',SYSDATE,3,2);
...
INSERT INTO TB_SCHEDULE VALUES(1,TO_DATE('2017-11-01','RRRR-MM-DD'),1,2);
INSERT INTO TB_SCHEDULE VALUES(2,TO_DATE('2017-11-11','RRRR-MM-DD'),2,4);

PROMPT INSERT DATA 그룹 게시판...
INSERT INTO TB_G_BOARD VALUES(1,'첫글','안녕하세요',SYSDATE,2,2);
INSERT INTO TB_G_BOARD VALUES(2,'사진','업로드했습니다',SYSDATE,3,2);
...
INSERT INTO TB_MESSAGE VALUES(1,1,2,'환영합니다! -STUDYHUB');
INSERT INTO TB_MESSAGE VALUES(2,2,3,'사진공유 부탁드려요');
...
INSERT INTO TB_SHARE_FILE VALUES(1,'토익800점 어휘','You can do it!',SYSDATE,'토익800어휘',NULL,NULL,2,3); --그룹 내 파일공유 게시판이므로 그룹정보를 알수있어야함
INSERT INTO TB_SHARE_FILE VALUES(2,'회화를 위한','You can do it!',SYSDATE,'회화팁',NULL,NULL,4,3);
...
2. 하루에 한번은 그룹게시판 방문하여 글 확인', TO_DATE(SYSDATE), 2,3);
INSERT INTO TB_G_NOTICE VALUES
