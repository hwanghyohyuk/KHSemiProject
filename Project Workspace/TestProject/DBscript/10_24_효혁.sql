...
INSERT INTO TB_SHARE_FILE VALUES(1,'토익800점 어휘','You can do it!',SYSDATE,'토익800어휘',NULL,1,2,3,1); --그룹 내 파일공유 게시판이므로 그룹정보를 알수있어야함
INSERT INTO TB_SHARE_FILE VALUES(2,'회화를 위한','You can do it!',SYSDATE,'회화팁',NULL,2,4,3,1);
