...
COMMENT ON COLUMN TB_SHARE_FILE.FILE_CATEGORYNAME IS '파일카테고리';
...
INSERT INTO TB_SCHEDULE VALUES(1,1,'2017년 10월 22일 일요일', 'PM', '04', '30', 'ONLINE', '강남역스타벅스');
INSERT INTO TB_SCHEDULE VALUES(2,2,'2017년 10월 27일 금요일', 'PM', '06', '50', 'OFFLINE', '학원에서');
...
INSERT INTO TB_SHARE_FILE VALUES(1,'토익800점 어휘','You can do it!',SYSDATE,'토익800어휘',NULL,1,2,3,1, 'reading'); --그룹 내 파일공유 게시판이므로 그룹정보를 알수있어야함
INSERT INTO TB_SHARE_FILE VALUES(2,'회화를 위한','You can do it!',SYSDATE,'회화팁',NULL,2,4,3,1, 'speaking');
