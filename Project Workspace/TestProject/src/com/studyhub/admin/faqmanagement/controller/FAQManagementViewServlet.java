...
/**
 * Servlet implementation class FAQManagementViewServlet
 */
@WebServlet("/faqmanagementview")
public class FAQManagementViewServlet extends HttpServlet {
     ...
     */
    public FAQManagementViewServlet() {
        super();
