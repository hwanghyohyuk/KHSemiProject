  ...
  var moveType = move; 
    if(moveWork==false){ 
      ...
      if(moveType==0){ 
         ...
         // 맨처음이미지를 왼쪽으로 이동시킨다. 
         $(".RollDiv > div > a:first").animate({marginLeft:-aWidth},{duration:moveSpeed,complete:function(){ 
      ...
      $(".RollDiv > div > a:first").animate({marginLeft:0},{duration:moveSpeed,complete:function(){ 
